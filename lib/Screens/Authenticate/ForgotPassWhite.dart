...
class ForgotPassWhite extends StatefulWidget {
  const ForgotPassWhite({Key? key}) : super(key: key);

  @override
  _ForgotPassWhiteState createState() => _ForgotPassWhiteState();
}

class _ForgotPassWhiteState extends State<ForgotPassWhite> {
  @override
